...
{-# OPTIONS_GHC -w #-}
module Paths_perso_2024b_JP_Righi (
    version,
...
getDynLibDir  = catchIO (getEnv "perso_2024b_JP_Righi_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "perso_2024b_JP_Righi_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "perso_2024b_JP_Righi_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "perso_2024b_JP_Righi_sysconfdir") (\_ -> return sysconfdir)
